...
INSERT INTO productos (nombre, precio, create_at) VALUES('Mac Book Pro', 899990, NOW());
...
insert into users(username,password,enable) value('eduard','$2a$10$iD1fv35/m0iUeJhMqtDYoumxryPNASj0Te51wDh0pyWTObBbMEECW',1);
insert into users(username,password,enable) value('admin','$2a$10$EHsGAyUpWdl3d0aeLLVHhOgm45XVAUiaePwCpiqK/VbZ61bH7VqoS',1);
